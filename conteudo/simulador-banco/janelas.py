...
def make_win_login() -> sg.Window:
    layout_login = [
        [sg.Text("Nome: "), sg.Input(k="Nome")],
        [sg.Text("Saldo Inicial: "), sg.Input(k="SaldoIni")],
...
def make_win_sacar():
    layout_sacar = [
        [sg.Text("Digite a quantia que deseja sacar: "), sg.Input(k="SacaQnt")],
...
def make_win_depositar():
    layout_depositar = [
        [sg.Text("Digite a quantia que deseja depositar: "), sg.Input(k="DeposQnt")],
        [sg.Button("Inserir", bind_return_key=True), sg.Cancel("Cancelar")]]
...
def make_win_transf():
    layout_transf = [
        [sg.Text("Digite a quantia que deseja transferir: "), sg.Input(k="TransfQnt")],
        [sg.Button("Inserir", bind_return_key=True), sg.Cancel("Cancelar")]]
...
def make_win_contaconj():
    layout_contaconj = [
        [sg.Text("Digite o nome do seu parceiro: "), sg.Input(k="NomeParc")], 
        [sg.Text("Digite o saldo inicial do seu parceiro: "), sg.Input(k="SaldoParc")],
        [sg.Button("Inserir", bind_return_key=True), sg.Cancel("Cancelar")]]
